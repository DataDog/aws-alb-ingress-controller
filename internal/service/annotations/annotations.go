...
import (
	...
	"github.com/kubernetes-sigs/aws-alb-ingress-controller/internal/service/annotations/tags"
	"github.com/kubernetes-sigs/aws-alb-ingress-controller/internal/service/annotations/targetgroup"
...
func (s *Service) Merge(b *Service, cfg *config.Configuration) *Service {
	return &Service{
...
type Extractor struct {
	annotations map[string]parser.ServiceAnnotation
}
...
func NewServiceAnnotationExtractor(cfg resolver.Resolver) Extractor {
	return Extractor{
		map[string]parser.ServiceAnnotation{
