...
// Reconciler reconciles an single service object
...
// Reconcile will reconcile the aws resources with k8s state of service.
func (r *Reconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if err := r.reconcileService(ctx, request.NamespacedName, service); err != nil {
		r.metricCollector.IncReconcileErrorCount(request.NamespacedName.String())
		return reconcile.Result{}, err
	}
...
func (r *Reconciler) reconcileService(ctx context.Context, serviceKey types.NamespacedName, service *corev1.Service) error {
...
func (r *Reconciler) buildReconcileContext(ctx context.Context, serviceKey types.NamespacedName, service *corev1.Service) context.Context {
	ctx = albctx.SetLogger(ctx, log.New(serviceKey.String()))
	if service != nil {
